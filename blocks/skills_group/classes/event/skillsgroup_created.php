...
/**
 * This is the skillsgroup created event class.  I have largely followed the guide at:
 ...
 */
class skillsgroup_created extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'skills_group';
    }
    ...
    public static function get_name() {
        return get_string('skillsgroupcreated', 'block_skills_group');
    }
    ...
    public function get_description() {
        return "User {$this->userid} " . get_string('creategroupinfo', 'block_skills_group') . $this->objectid;
    }
    ...
    public function get_legacy_logdata() {
        $info = "User {$this->userid} " . get_string('creategroupinfo', 'block_skills_group') . $this->objectid;
        ...
        return array($this->courseid, get_string('pluginname', BLOCK_SG_LANG_TABLE),
            get_string('skillsgroupcreated', 'block_skills_group'), $url,
