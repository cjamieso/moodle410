...
/**
 * This is the skillsgroup left event class.  I have largely followed the guide at:
 ...
 */
class skillsgroup_left extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('skillsgroupleft', 'block_skills_group');
    }
    ...
    public function get_description() {
        return "User {$this->userid} " . get_string('leavegroupinfo', 'block_skills_group') . $this->objectid;
    }
    ...
    public function get_legacy_logdata() {
        $info = "User {$this->userid} " . get_string('leavegroupinfo', 'block_skills_group') . $this->objectid;
        ...
        return array($this->courseid, get_string('pluginname', BLOCK_SG_LANG_TABLE),
            get_string('skillsgroupleft', 'block_skills_group'), $url,
