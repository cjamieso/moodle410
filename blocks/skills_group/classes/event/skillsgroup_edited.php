...
/**
 * This is the skillsgroup edited event class.  I have largely followed the guide at:
 ...
 */
class skillsgroup_edited extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('skillsgroupedited', 'block_skills_group');
    }
    ...
    public function get_description() {
        return "User {$this->userid} " . get_string('editgroupinfo', 'block_skills_group') . $this->objectid;
    }
    ...
    public function get_legacy_logdata() {
        $info = "User {$this->userid} " . get_string('editgroupinfo', 'block_skills_group') . $this->objectid;
        ...
        return array($this->courseid, get_string('pluginname', BLOCK_SG_LANG_TABLE),
            get_string('skillsgroupedited', 'block_skills_group'), $url,
