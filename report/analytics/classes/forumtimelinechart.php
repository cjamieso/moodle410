...
/**
 * forumtimelinechart class
 *
 * This class is used for the time based forum engagement graph and filters.
 *
 * @package    report_analytics
 * @copyright  2016 Craig Jamieson
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class forumtimelinechart extends activitytimelinechart{

    /**
     * Change the default action filter to be forum-specific.
     *
