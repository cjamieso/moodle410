 ...
 */
class activitychart_renderable extends chart_renderable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->average = $this->get_filter_data('average', get_string('averagefilter', 'report_analytics'));
        $data->viewstooltip = $this->get_help_tooltip('views', 'none');
        $data->interactionstooltip = $this->get_help_tooltip('interactions', 'none');
        return $data;
    }
