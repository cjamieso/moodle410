 ...
 */
class format_collblct_courseformatlib_test extends advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        set_config('enableadditionalmoddata', 2, 'format_collblct');
    ...
    public function test_set_up() {
        ...
        $this->assertEquals('1.0', get_config('format_collblct', 'defaulttoggleforegroundopacity'));
        $this->assertEquals('1.0', get_config('format_collblct', 'defaulttoggleforegroundhoveropacity'));
        $this->assertEquals('1.0', get_config('format_collblct', 'defaulttogglebackgroundopacity'));
        $this->assertEquals('1.0', get_config('format_collblct', 'defaulttogglebackgroundhoveropacity'));

        set_config('defaulttoggleforegroundopacity', '0.5', 'format_collblct');
        set_config('defaulttoggleforegroundhoveropacity', '0.6', 'format_collblct');
        set_config('defaulttogglebackgroundopacity', '0.7', 'format_collblct');
        set_config('defaulttogglebackgroundhoveropacity', '0.8', 'format_collblct');

        // Check that the defaults now have the new values.
        $this->assertEquals('0.5', get_config('format_collblct', 'defaulttoggleforegroundopacity'));
        $this->assertEquals('0.6', get_config('format_collblct', 'defaulttoggleforegroundhoveropacity'));
        $this->assertEquals('0.7', get_config('format_collblct', 'defaulttogglebackgroundopacity'));
        $this->assertEquals('0.8', get_config('format_collblct', 'defaulttogglebackgroundhoveropacity'));
    ...
    public function test_showadditionalmoddata_default_yes() {
        ...
        set_config('defaultshowadditionalmoddata', 2, 'format_collblct');
        set_config('coursesectionactivityfurtherinformationchoice', 2, 'format_collblct');
        set_config('coursesectionactivityfurtherinformationdata', 2, 'format_collblct');

        $thesettings = $this->courseformat->get_settings();
        $this->assertEquals(2, $thesettings['showadditionalmoddata']);

        set_config('coursesectionactivityfurtherinformationchoice', 1, 'format_collblct');
        set_config('coursesectionactivityfurtherinformationdata', 1, 'format_collblct');
        set_config('coursesectionactivityfurtherinformationlesson', 2, 'format_collblct');
    ...
    public function test_showadditionalmoddata_reset() {
        ...
        set_config('defaultshowadditionalmoddata', 1, 'format_collblct');
        set_config('coursesectionactivityfurtherinformationlesson', 2, 'format_collblct');
