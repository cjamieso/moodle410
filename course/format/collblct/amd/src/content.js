 ...
 *
 * @module     format_collblct/content
 * @class      format_collblct/content
...
export default class collblctComponent extends Component {
    ...
    _refreshCourseSectionlist({element}) {
        ...
        if (listparent) {
            this._fixcollblctSectionOrder(listparent, sectionlist, this.selectors.SECTION, this.dettachedSections, createSection);
        }
    }
     ...
     */
    async _fixcollblctSectionOrder(container, neworder, selector, dettachedelements, createMethod) {
