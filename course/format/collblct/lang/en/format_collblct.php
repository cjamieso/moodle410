...
$string['collblctsidewidthlang'] = 'en-28px';
...
$string['courseadditionalmoddatastudentsinfolimitedshow'] = 'Additional information will show for the enabled activities for {$a->students} students as the number does not exceed the maximum \'{$a->maxstudents}\' set by the administrator on the Collapsed Topics with Collapsed Labels course format setting \'courseadditionalmoddatamaxstudents\'.';
$string['courseadditionalmoddatastudentsinfolimitednoshow'] = 'Additional information will NOT show for the enabled activities for {$a->students} students as the number exceededs the maximum \'{$a->maxstudents}\' set by the administrator on the Collapsed Topics with Collapsed Labels course format setting \'courseadditionalmoddatamaxstudents\'.';
...
$string['collblct:changeactivitymeta'] = 'Change or reset the activity meta';
...
$string['informationsettingsdesc'] = 'Collapsed Topics with Collapsed Labels format information';
$string['settings'] = 'Settings';
$string['settingssettings'] = 'Settings settings';
$string['settingssettingsdesc'] = 'Collapsed Topics with Collapsed Labels format settings';
