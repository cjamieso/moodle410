...
// English American Translation of Collapsed Topics with Collapsed Labels Course Format.

// Used in format.php.
$string['collblctsidewidthlang'] = 'en_us-28px';
...
// Capabilities.
$string['collblct:changecolour'] = 'Change or reset the color';
