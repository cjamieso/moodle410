...
namespace format_collblct\output\courseformat\content\section;
...
class controlmenu extends controlmenu_base {
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        if (has_capability('moodle/course:manageactivities', $coursecontext)) {
            $duplicatestr = get_string('duplicate', 'format_collblct');
            $duplicateurl = new moodle_url('/course/format/collblct/duplicate.php',
            ...
            $link->add_action(new \confirm_action(get_string('duplicateconfirm', 'format_collblct'), null,
                $duplicatestr));
