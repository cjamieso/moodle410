...
class admin_setting_markdown extends \admin_setting {
    ...
    public function output_html($data, $query='') {
        ...
        if (file_exists("{$CFG->dirroot}/course/format/collblct/{$this->filename}")) {
            $filecontents = file_get_contents($CFG->dirroot.'/course/format/collblct/'.$this->filename);
        } else {
        ...
        return $OUTPUT->render_from_template('format_collblct/ct_admin_setting_markdown', $context);
    }
}
