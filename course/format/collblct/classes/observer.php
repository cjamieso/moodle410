 ...
 */
class format_collblct_observer {
    ...
    public static function course_content_deleted(\core\event\course_content_deleted $event) {
        global $DB;
        $DB->delete_records("user_preferences", array("name" => 'collblct_toggle_'.$event->objectid)); // This is the $courseid.
    }
    ...
    */
    ...
    public static function role_allow_view_updated() {
        ...
        \format_collblct\activity::invalidatestudentrolescache();
        \format_collblct\activity::invalidatemodulecountcache();
        \format_collblct\activity::invalidatestudentscache();
    }
    ...
    public static function user_enrolment_created(\core\event\user_enrolment_created $event) {
        if ($courseformat = self::iscollblct($event->courseid)) {
            \format_collblct\activity::userenrolmentcreated($event->relateduserid, $event->courseid, $courseformat);
        }
    }
    ...
    public static function user_enrolment_updated(\core\event\user_enrolment_updated $event) {
        if ($courseformat = self::iscollblct($event->courseid)) {
            \format_collblct\activity::userenrolmentupdated($event->relateduserid, $event->courseid, $courseformat);
        }
    }
    ...
    public static function user_enrolment_deleted(\core\event\user_enrolment_deleted $event) {
        if ($courseformat = self::iscollblct($event->courseid)) {
            \format_collblct\activity::userenrolmentdeleted($event->relateduserid, $event->courseid, $courseformat);
        }
    }
    ...
    public static function course_module_created(\core\event\course_module_created $event) {
        if ($courseformat = self::iscollblct($event->courseid)) {
            \format_collblct\activity::modulecreated($event->objectid, $event->courseid, $courseformat);
        }
    }
    ...
    public static function course_module_updated(\core\event\course_module_updated $event) {
        if ($courseformat = self::iscollblct($event->courseid)) {
            \format_collblct\activity::moduleupdated($event->objectid, $event->courseid, $courseformat);
        }
    }
    ...
    public static function course_module_deleted(\core\event\course_module_deleted $event) {
        if ($courseformat = self::iscollblct($event->courseid)) {
            \format_collblct\activity::moduledeleted($event->objectid, $event->courseid, $courseformat);
        }
    }
     ...
     *
     * @return object | bool format_collblct object or false if not a Collapsed Topics course.
     */
    private static function iscollblct($courseid) {
        $courseformat = course_get_format($courseid);
        if ($courseformat instanceof format_collblct) {
            return $courseformat;
        }
        return false;
    }
